...
namespace lab.OCRSample.Extensions
{
    public static class SelectListItemExtension
    {

        public static List<SelectListItem> PopulateDropdownList<T>(this List<T> objectList, string valueField, string textField, bool isEdit = false, string selectedValue = "", string selectText = "- Select -")
        {
            try
            {
        ...
        public static List<SelectListItem> PopulateDropdownUnorderedList<T>(this List<T> objectList, string valueField, string textField, bool isEdit = false, string selectedValue = "", string selectText = "-- Select --")
        {
            try
            {
                if (string.IsNullOrEmpty(selectedValue))
